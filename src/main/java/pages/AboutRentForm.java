...
public class AboutRentForm {
    ...
    // Выбор даты доставки
    public AboutRentForm writeDeliveryDate (String deliveryDate) {
        driver.findElement(deliveryDateField).sendKeys(deliveryDate);
        return this;
    }

    //Выбор срока аренды
    public AboutRentForm selectRentalPeriod (String rentPeriod){
    ...
    //Выбор цвета самоката
    public AboutRentForm selectColor(String color){
    ...
    // Ввод коментария
    public AboutRentForm writeComment (String comment){
